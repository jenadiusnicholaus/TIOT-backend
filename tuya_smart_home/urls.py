...
from .views import DeviceViewViewSet, RentalOwnerPropertyDeviceViewSet, DeviceFunctionsViewSet, ControllDeviceVset, DeviceStatusViewSet, DeviceLogsViewSet, DeviceStatusLogsViewSet,RentalOwnerProperties, RentalOwnerPropertyRoomViewSet, RentalOwnerPropertyRoomTypeViewSet
